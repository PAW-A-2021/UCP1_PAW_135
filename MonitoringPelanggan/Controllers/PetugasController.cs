...
namespace MonitoringPelanggan.Controllers
{
    public class PetugasController : Controller
    {
        ...
        public PetugasController(MonitoringPlgContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPetugas,Username,Password,Email,FullName,NoHp")] Petuga petuga)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPetugas,Username,Password,Email,FullName,NoHp")] Petuga petuga)
        {
